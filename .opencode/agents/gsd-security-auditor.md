...
**Verification depth scales with `asvs_level`** (see @C:/Users/rafael/Desktop/partitura-api/.opencode/gsd-core/references/security-asvs-levels.md for full definitions):
