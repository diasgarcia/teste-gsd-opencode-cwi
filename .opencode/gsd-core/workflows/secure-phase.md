...
```
Agent(
  prompt="Read C:/Users/rafael/Desktop/partitura-api/.opencode/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/rafael/Desktop/partitura-api/.opencode/gsd-core/templates/SECURITY.md`
