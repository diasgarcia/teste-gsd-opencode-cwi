...
Display `Phase ${PHASE_NUM} ✅ ${PHASE_NAME} — Verification passed`, run `@C:/Users/rafael/Desktop/partitura-api/.opencode/gsd-core/workflows/transition.md`, then Proceed to iterate step.
...
On "All good — continue": set VERIFICATION frontmatter `status: passed`, display `Phase ${PHASE_NUM} ✅ Human validation passed`, run `@C:/Users/rafael/Desktop/partitura-api/.opencode/gsd-core/workflows/transition.md`, then iterate.
...
Read and execute: `C:/Users/rafael/Desktop/partitura-api/.opencode/gsd-core/references/autonomous-smart-discuss.md`
